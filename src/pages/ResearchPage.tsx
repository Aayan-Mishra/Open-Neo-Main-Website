...
const papers = [
  {
    title: 'Announcing Noema Research - SOTA Generative AI',
    authors: 'Noema Research Founding team',
    date: 'July 2025',
    conference: 'News',
    abstract: 'Today, we are thrilled to announce the launch of Noema Research. As a key contributor to the generative AI research community, our mission is to pioneer and refine state-of-the-art generative deep learning models for media, including images and videos, and to push the boundaries of creativity, efficiency, and diversity. We believe that generative AI will…',
