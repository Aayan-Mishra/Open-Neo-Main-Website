...
const papers = [
  {
  title: 'Announcing Noema Research',
    authors: 'Noema Research Founding team',
    date: 'July 2025',
    conference: 'News',
  abstract: 'Today, we are thrilled to announce the launch of Noema Research. Our mission is to advance rigorous research and tools that enable conscious enhancement of cognitive, educational, and medical capabilities, and to responsibly translate those advances into practical systems.',
    link: 'https://apexion-industries.vercel.app/blog/introducing-apexion-industries',
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Explore our latest research papers, announcements, and scientific contributions focused on enhancing cognition, education, and medical technology through rigorous methods and responsible experimentation.
          </p>
        </div>
      </section>
